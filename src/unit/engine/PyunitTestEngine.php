...
final class PyunitTestEngine extends ArcanistUnitTestEngine {
  ...
  public function run() {
    ...
    $result->setUserData("hello");
    // FIXME: coverage data structure
    //$result->setCoverage(1);

    $results[] = $result;
    $results[] = $result;
    $results_all = array();
    $results_all[] = $results;
    # FIXME: run real tests and parse results
    //var_dump($results_all);
    return array_mergev($results_all);
